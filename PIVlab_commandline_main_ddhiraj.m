...
directory= sprintf('/Users/dhirajksimngh/Desktop/snowpixel/TIV_2019_5_april/Travis_data/piv', trials(trial)); %directory containing the images you want to analyze
...
realdist = 39; % Enter the real distance in mm
dist = 100; % Enter the number of pixel
time = 8; %Enter the real time in ms
...
% s{4,1}= 'Mask';                  s{4,2}=[];         % If needed, generate via: imagesc(image); [temp,Mask{1,1},Mask{1,2}]=roipoly;
 s{5,1}= 'ROI';                   s{5,2}=[146,76,900-146,740-76]; % Region of interest: [x,y,width,height] in pixels, may be left empty
