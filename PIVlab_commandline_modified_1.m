...
s{5,1}= 'ROI';                   s{5,2}=[100,100,200,200];         % Region of interest: [x,y,width,height] in pixels, may be left empty
...
filename = sprintf('G:/Vortex Ring Experiments/Polymer_soln_expts/PAMH_5ppm/Global/Ensemble/L100_V100/mat_files/data_%01d.mat',trial);
save (filename,'x','y','u_filt','v_filt','vort_filt');

% Saving in respective folder
mkdir (sprintf('G:/Vortex Ring Experiments/Polymer_soln_expts/PAMH_5ppm/Global/Ensemble/L100_V100/Trial_%01d/PIV_auto_output',trial));
filename = sprintf('G:/Vortex Ring Experiments/Polymer_soln_expts/PAMH_5ppm/Global/Ensemble/L100_V100/Trial_%01d/PIV_auto_output/data.mat',trial);
save (filename,'x','y','u_filt','v_filt','vort_filt');
