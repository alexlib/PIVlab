...
dann einfach beide mit hold... �bereinander plotten. und dann transparenz
...
if size(filepath,1) > 1
    ...
    %checken ob nicht gr��er als geladene frame anzahl.
...
%was ist gr��er, x oder y. dann entsprechend die x oder y gr��e der axes nehemn
xextend=size(vx,2);
yextend=size(vx,1);
if yextend<xextend
            ...
            case 9 %tangent
                if size(xposition,1)<=1 %user did not choose circle series
                    ...
                    for m=1:30
                        ...
                        sinalpha(m,1)=sinalpha(m,2); %ersten winkel f�llen
...
if isempty(resultslist)==0
    if size(filepath,1)>0
        ...
        %man k�nnte erstmal alle frames stapeln, und danach nur die verwenden deren
        %nummer gew�hlt war.
        ...
        if selectionok==1
            ...
            if sizeerror==0
                ...
                if selectionok==1
                    ...
                    %kopieren in temp "originalmaske", dann alles l�schen was nicht
                    %ausgew�hlt. (auf [] setzen)
                    ...
                    for i=1:size(newmaskx,1)
                        ...
                        %aus allen gew�hlten frames geh�ngt.
                    ...
                    %typevectoralle ist ausgabe f�r gui
